package com.hz.source.master.core.controller.question;
...
import com.hz.source.master.core.common.utils.SignUtil;
...
import com.hz.source.master.core.model.RequestEncryptionJson;
...
import com.hz.source.master.core.protocol.request.question.RequestQuestion;
...
public class QuestionController {
     ...
     * local:http://localhost:8082/source/qt/getDataMList
     ...
     * @author yoko
     * @date 2019/11/25 22:58
     * local:http://localhost:8082/source/qt/getDataDList
     * 请求的属性类:RequestAppeal
...
//                ComponentUtil.redisService.set(token, "3");
     ...
     * @author yoko
     * @date 2019/11/25 22:58
     * local:http://localhost:8082/source/qt/getDataD
     * 请求的属性类:RequestAppeal
